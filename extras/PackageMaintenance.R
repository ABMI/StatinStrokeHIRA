...
OhdsiRTools::checkUsagePackage("AFStatinStroke")
OhdsiRTools::updateCopyrightYearFolder()
install.packages("devtools")
devtools::spell_check()

# Create manual -----------------------------------------------------------
unlink("extras/AFStatinStroke.pdf")
shell("R CMD Rd2pdf ./ --output=extras/AFStatinStroke.pdf")
...
OhdsiRTools::createRenvLockFile(rootPackage = "AFStatinStroke",
                                mode = "description",
